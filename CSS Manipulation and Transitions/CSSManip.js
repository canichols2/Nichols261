...
//Use dev tools and Step through this function to see how each element works and how they break/don't work
function manipulateBad(){
    var div = document.getElementById("test1");
    div.style.backgroundColor = 58;  //doesn't get set as a value
    div.style.backgroundColor = "58" //
    div.style.backgroundColor = null //Removes the blue background
    div.style.height = null     //Removes the Height
    div.style.height = true     //Doesn't set as anything
...
/// Just say no to changing classes
/// change just style attributes
